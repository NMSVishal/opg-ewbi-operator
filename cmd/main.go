...
import (
	...
	"github.com/NMSVishal/opg-ewbi-operator/internal/controller"
	"github.com/NMSVishal/opg-ewbi-operator/internal/opg"
	"github.com/NMSVishal/opg-ewbi-operator/internal/options"
...
func main() {
	...
	var opgInsecureSkipVerify bool
	...
	flag.BoolVar(&opgInsecureSkipVerify, "opg-insecure-skip-verify", false,
	...
	if secureMetrics {
		...
		// If cert-manager is enabled in config/default/kustomization.yaml,
